...
label prologue:
    ...
    scene anim 1 _prologue onlayer master
    with fade3

    $ renpy.pause(9.4, hard=True)

    scene anim 2 _prologue onlayer master
    with fade3

    $ renpy.pause(9.4, hard=True)

    scene anim 3 _prologue onlayer master
    with fade3
    ...
    show blinking onlayer master with dissolve
    ...
    scene anim prolog_15 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim prolog_3 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim prolog_4 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    ...
    scene anim prolog_5 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim prolog_14 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim prolog_11 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    ...
    scene anim prolog_2 onlayer master
    with fade
    $ renpy.pause(1)
    ...
    scene anim intro_1 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim intro_2 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim intro_3 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim intro_4 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim intro_5 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    ...
    scene anim intro_8 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    scene anim intro_7 onlayer master
    with fade
    $ renpy.pause(3, hard=True)
    ...
    scene anim intro_9 onlayer master
    with fade2
    ...
    scene anim intro_10 onlayer master
    with fade

    play sound sfx_intro_bus_door_open

    $ renpy.pause(3, hard=True)
    scene anim intro_11 onlayer master
    with fade
    $ renpy.pause(1, hard=True)

    stop sound_loop fadeout 4

    scene anim intro_13 onlayer master
    with fade2
    $ renpy.pause(3, hard=True)
...
label opening:
    ...
    scene op_back onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show op_sl onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show op_un onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show op_us onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show op_dv onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show op_mi onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show op_uv onlayer master
    with dissolve2

    $ renpy.pause(2, hard=True)

    show logo_day onlayer master:
        pos (400,150)
    with dissolve2
