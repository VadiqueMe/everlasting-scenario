...
label day1:
    ...
    show blink onlayer master with dissolve
    $ renpy.pause(3)
    ...
    show un normal pioneer far at left onlayer master with dissolve   
    ...
    show un surprise pioneer far at left onlayer master with dspr
    ...
    show us grin sport far at right onlayer master with dissolve 
    ...
    show un surprise pioneer far at left onlayer master with dspr
    show us surp3 sport far at right onlayer master with dspr:
    ...
    show un shy pioneer far at left onlayer master with dspr
    ...
    scene cg d1_grasshopper onlayer master
    with dissolve
    ...
    $ persistent.sprite_time = "day"
    scene bg ext_clubs_day onlayer master
    show us grin sport at left onlayer master with dspr:
    ...
    show dv angry pioneer2 at center onlayer master with dissolve
    ...
    "Я обернулся."
    show sl smile swim at center onlayer master with dissolve
    ...
    me "А… я… да… Семен…"
    show sl smile2 swim at center onlayer master with dspr
    ...
    window show
    "Мы вышли на площадь."
    show dv smile pioneer2 far at left  onlayer master with dissolve   
    show us grin sport far at right  onlayer master with dissolve
    "По ней друг за другом бегали «СССР» и девочка, ударившая меня по спине."
    th "Это у них игра, что ли, такая?"
    show sl angry pioneer at center onlayer master with dissolve
    sl "Ульяна, хватит бегать! Я все Ольге Дмитриевне расскажу!"

    $ meet('us','Ульяна')

    show us laugh sport far behind sl at right  onlayer master with dspr
    ...
    scene cg d1_rena_sunset onlayer master
    ...
    show us grin sport far behind sl at left  onlayer master with dissolve   
    ...
    show un normal pioneer far behind sl at left  onlayer master with dissolve   
    ...
    show un shy pioneer behind sl at left onlayer master with dissolve
    un "Да я не…"
    ...
    me "Да, а ты откуда…"
    show el grin pioneer at center onlayer master with dissolve 
    ...
    show dv normal pioneer2 far at left  onlayer master with dissolve   
    ...
    show el scared pioneer at center onlayer master with dspr
    ...
    show dv angry pioneer2 far at left onlayer master with dspr
    ...
    menu:
        ...
        "Ничего не делать":
            $ lp_dv = lp_dv + 1
            show dv angry pioneer2 at left onlayer master with dissolve
            window show
    ...
    show dv normal pioneer2 at left onlayer master with dissolve
    dv "А что такое?"
    mt "Ты как одета?"
    dv "А как я одета?"
    "Действительно, наряд ее был несколько вызывающим…"
    mt "Немедленно приведи в порядок форму!"
    show dv sad pioneer2 at left onlayer master with dspr
    dv "Ладно-ладно…"
    ...
    scene cg d1_food_normal onlayer master
    with dissolve
    ...
    scene cg d1_food_skolop onlayer master
    with vpunch
    ...
    me "Ах ты, маленькая…"
    show us laugh2 pioneer far at center  onlayer master with dissolve   
    ...
    show cg d1_sl_dinner onlayer master
    with dissolve
    ...
    show cg d1_sl_dinner_0 onlayer master with dspr
    ...
    show cg d1_sl_dinner onlayer master with dspr
    ...
    $ persistent.sprite_time = "day"
    scene bg int_dining_hall_people_day onlayer master
    show us laugh pioneer onlayer master at center
    show prologue_dream onlayer master
    with fade
    ...
    $ persistent.sprite_time = "day"
    scene bg ext_boathouse_day onlayer master
    show sl smile swim onlayer master at center
    show prologue_dream onlayer master
    with fade
    ...
    scene bg ext_square_night onlayer master
    show un night onlayer master at center
    show prologue_dream onlayer master
    with fade
    ...
    scene bg ext_houses_day onlayer master
    show dv angry pioneer2 onlayer master at center
    show prologue_dream onlayer master
    with fade
    $ persistent.sprite_time = "day"
